...
class App:
    ...
    def __init__(self):
        ...
        # Animating Words
        animate_words(self.window, "AutumnMiles", label_1)
        """ Start Button """
        ...
        """ Copyright """
        copy_right = CTkLabel(self.window, text=f"© {datetime.datetime.now().year}", font=(window_font, (window_font_size - 10)), fg_color=color_scheme,
